...
public class Auto implements Iterable<Auto.Model>, Vehicle, Cloneable, Serializable {
    private String mark;
    ...
    public class AutoIterator implements Iterator<Model> {
        private int count = models.length;
        private int c = 0;
    ...
    public static class Memento implements Serializable {
        ...
        static void setAuto(Auto auto) throws IOException {
    ...
    protected static class Model implements Serializable {
        ...
        public String toString() {
            return "\n" +
                    "название модели " + getName() + "\n" +
                    "цена модели " + Double.toString(getPrice()) + "\n";
        }
